            ...
            <Card className="flex flex-col">
              <CardHeader>
                ...
                <div className="mt-4">
                  ...
                  <div className="text-sm text-muted-foreground">₹0 - Forever free</div>
                </div>
              </CardHeader>
            ...
            <Card className="flex flex-col border-primary relative">
              ...
              <CardHeader>
                ...
                <div className="mt-4">
                  ...
                  <div className="text-sm text-muted-foreground">₹1,425 per month</div>
                </div>
              </CardHeader>
              <CardContent className="flex-1">
                <ul className="space-y-2 text-sm">
            ...
            <Card className="flex flex-col">
              <CardHeader>
                ...
                <div className="mt-4">
                  ...
                  <div className="text-sm text-muted-foreground">₹7,425 per month</div>
                </div>
              </CardHeader>
              <CardContent className="flex-1">
                <ul className="space-y-2 text-sm">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  plans, we also offer invoice-based payments.
                </p>
              </CardContent>
            </Card>
            <Card>
